<div class="container-principal">
    ...
    <div class="panel-derecho-registro">
        <div class="container-registro">
            <div class="container-panel-derecho-registro">
                <a href="./adminpanel.php">
                    <i class=" iconos fas fa-user-lock"></i>
                </a>

                <!-- para poder enviar archivos en necesario agregar  enctype="multipart/form-data" al form-->
                <form id="registro" action="./registro.php" method="POST" enctype="multipart/form-data">
                    ...
                    <input class="btn-input-registro" type="submit" name="registrar" value="Registrar">
                </form>
            </div>
        </div>
    </div>
